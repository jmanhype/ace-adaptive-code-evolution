IO.puts("Testing webhook handler with PR edited event...")
...
try do
  result = AceWeb.WebhookController.process_pr_edited_debug(test_payload)
  IO.inspect(result, label: "Result")
rescue
  e ->
    IO.puts("Error processing webhook:")
    IO.inspect(e, label: "Exception")
    IO.inspect(__STACKTRACE__, label: "Stack trace")
end 